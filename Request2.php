...
<body>
  ...
  <!-- Full Page Intro -->
  <div class="view full-page-intro" style="background-image: url('https://i.imgur.com/gWuJhm4.png'); background-repeat: no-repeat; background-size: cover;">
    ...
    <div class="mask rgba-black-light d-flex justify-content-center align-items-center">
      ...
      <div class="container">
        ...
        <div class="row wow fadeIn">
          ...
          <!--Grid column-->
          <div class="col-md-12 mb-12 white-text text-center">
            <div align = "center">
            <img src="https://i.imgur.com/hRmRNB1.png" width="1000" height="350" style="margin = 50px;">
            </div>
            <hr class="hr-light">

            <p>
              <strong>Live the best experience in "La isla del encanto"</strong>
            </p>

            <p class="mb-4 d-none d-md-block">
              <strong>"Planealo" with us</strong>
            </p>
  ...
  <main>
    <div class="container">
      ...
      <section id="examples" class="text-center">
        ...
        <!-- Heading -->
        <h2 class="mb-5 font-weight-bold">Servicios</h2>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-12 mb-4">
            ...
            <div class="view overlay z-depth-1-half">
              <img src="https://i.imgur.com/1LaDNTD.jpg" class="img-fluid" alt="">
              <div class="mask rgba-white-slight"></div>


            <h4 class="my-4 font-weight-bold">Tourism</h4>
            <p class="grey-text">We have attractive beaches, gastronomy and unforgettable places.</p>
              </div>
          </div>
          <!--Grid column-->
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            ...
            <h4 class="my-4 font-weight-bold">Investors</h4>
            <p class="grey-text">Get to know our start ups and your potential clients.</p>
              </div>
          </div>
          <!--Grid column-->
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            ...
            <h4 class="my-4 font-weight-bold">Patients</h4>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-12 mb-4">
            ...
            <h4 class="my-4 font-weight-bold">Students</h4>
            <p class="grey-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reprehenderit maiores nam, aperiam
              minima
              assumenda deleniti hic.</p>
              </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            ...
            <h4 class="my-4 font-weight-bold">Workers</h4>
            <p class="grey-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reprehenderit maiores nam, aperiam
              minima
              assumenda deleniti hic.</p>
              </div>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            ...
            <h4 class="my-4 font-weight-bold">Settlers</h4>
            <p class="grey-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reprehenderit maiores nam, aperiam
              minima
              assumenda deleniti hic.</p>
              </div>
